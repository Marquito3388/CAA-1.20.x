...
public class StarShield extends Item implements Equipable {
    public static final int EFFECTIVE_BLOCK_DELAY = 5;
    public static final float MINIMUM_DURABILITY_DAMAGE = 3.0F;
    public static final String TAG_BASE_COLOR = "Base";

    public StarShield(Item.Properties pProperties) {
        super(pProperties);
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pToolTipComponent, TooltipFlag pIsAdvanced) {
        ...
        pToolTipComponent.add(Component.literal("§6I can do this all day...§r"));
