...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new CAARecipesProvider(packOutput));

        BlockTagsProvider blockTagsProvider = new CAABlockTagGenerator(packOutput, lookupProvider, existingFileHelper);
