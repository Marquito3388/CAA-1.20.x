...
public class MetalManipulatorRecipe extends AbstractCookingRecipe {
    public MetalManipulatorRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(CAABlocksClass.METAL_MANIPULATOR.get());
    }
    ...
    public static class Type implements RecipeType<MetalManipulatorRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<MetalManipulatorRecipe> {
        private final int defaultCookingTime;
        public static final MetalManipulatorRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public MetalManipulatorRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new MetalManipulatorRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public MetalManipulatorRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, MetalManipulatorRecipe pRecipe) {
